...
export default function Graph() {
  ...
  }, [graphData.links.length, cfg.charge, cfg.maxDist])
  ...
  const pixelRatio = Math.min(window.devicePixelRatio || 1, cfg.pixRatio)
  ...
  return (
    <ForceGraph3D
      ...
      // @ts-expect-error pixelRatio is supported by the underlying renderer
